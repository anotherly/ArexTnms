...
(3,NULL,'전송설비','/facility/transmission.do?screen=systems',3,'1','전송설비 관리','Y'),
(4,NULL,'행선안내설비','/facility/pids.do?screen=equipment',4,'1','행선안내설비 관리','Y'),
(5,NULL,'전화교환설비','/facility/pbx.do?screen=switch',5,'1','전화교환설비 관리','Y'),
(6,NULL,'영상감시설비(CCTV)','/facility/cctv.do?screen=cctv',6,'1','영상감시설비 관리','Y'),
(7,NULL,'CCTV 영상관리','/main/dashboard.do?screen=video',7,'1','사용하지 않는 메뉴','N'),
(8,NULL,'SCADA 출입보안설비','/facility/scada.do?screen=scada',8,'1','SCADA 출입보안설비 관리','Y'),
(9,NULL,'연동주기 관리','/performance/cycle.do?screen=cycle',9,'1','연동주기 관리','Y'),
(10,NULL,'임계치 관리','/performance/threshold.do?screen=threshold',10,'1','임계치 관리','Y'),
(11,NULL,'성능관리','/performance/overview.do?screen=performance',11,'1','성능관리','Y'),
(12,NULL,'Raw 데이터 관리','/performance/raw.do?screen=raw',12,'1','Raw 데이터 관리','Y'),
(13,NULL,'실시간 장애','/fault/realtime.do?screen=faults',13,'1','실시간 장애','Y'),
(14,NULL,'장애이력·조치','/fault/history.do?screen=faultHistory',14,'1','장애이력 및 조치','Y'),
(15,NULL,'장애 예외설정','/fault/exceptions.do?screen=exceptions',15,'1','장애 예외설정','Y'),
(16,NULL,'장애유형 관리','/fault/types.do?screen=faultTypes',16,'1','장애유형 관리','Y'),
(17,NULL,'장애·성능 보고서','/report/fault-performance.do?screen=reports',17,'1','장애 및 성능 보고서','Y'),
(18,NULL,'사용자 계정 설정','/user/list.do?screen=users',18,'1','사용자 계정 설정','Y'),
(19,NULL,'권한 관리','/auth/list.do?screen=auth',19,'1','메뉴 및 기능 권한 관리','Y'),
(20,NULL,'계정 신청 현황','/user/applications.do?screen=applications',20,'1','계정 신청 현황','Y'),
(21,NULL,'알림·SMS 설정','/main/dashboard.do?screen=notify',21,'1','사용하지 않는 메뉴','N'),
(22,NULL,'공통코드·UI 설정','/setting/common-ui.do?screen=settings',22,'1','공통코드 및 UI 설정','Y'),
(23,NULL,'작업로그 조회','/audit/job-log.do?screen=logs',23,'1','사용자 작업로그 조회','Y')
...
(USER_ID, USER_NM, USER_ENPSWD, AUTHRT_SN, OGDP_BZENTY_NM, DEPT_NM, USER_STTS_NM,
 PSWD_EXPRY_YMD, LGN_FAIL_NOCS, USE_YN)
VALUES
('admin','시스템관리자','$2a$10$n3UL88OtFJB7L96YiBlwJupIPtRPUIfsNzJehj/ySFzNhEeyupjx6',
 1,'공항철도','정보통신팀','정상',DATE_ADD(CURDATE(), INTERVAL 90 DAY),0,'Y')
ON DUPLICATE KEY UPDATE USER_NM=VALUES(USER_NM), AUTHRT_SN=1, USER_STTS_NM='정상', USE_YN='Y';
